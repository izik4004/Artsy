...
const Me = () => {
  ...
  <div className="container px-5  mx-auto">
    <div className="mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-3/5  rounded-lg" src={feature1.image}/>
      <div className='absolute container mx-auto text-white text-xl'>rekjjkkljfkljdfghhhhhhhhhhhhhhhhhhhh5555555555555555555555555555555
      jkdjkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkhjjjjjjjjjjjjjjjjjjjjelkjelr</div>
